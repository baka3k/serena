...
* Tools:
  ...
  * `GenerateLosslessSemanticTreeTool` now emits OpenRewrite-style IR for C++ via a pluggable adapter architecture (other languages still return Serena's structural tree).
